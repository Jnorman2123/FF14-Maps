...
function RegionMapCont(props) {
    ...
    let createZoneLegend = (region) => {
        ...
        zones.map(z => {
            ...
            let zone_icon = createIcon(zone_jpg, highlight_size);
    ...
    let bounds= new LatLngBounds(this.revertLat(1,1), this.revertLat(41.9, 41.9));

    return (
        <Container style={{padding: 0}}>
            <RegionMapComponent mapName={mapName} bounds={bounds} center={props.center} 
