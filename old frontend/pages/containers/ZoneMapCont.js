...
class ZoneMapCont extends Component {
    ...
    render() {
        ...
        let in_zone_quests = [];
        let marker_z = 50;
        let bounds= new LatLngBounds(this.props.bounds[0], this.props.bounds[1]);
        ...
        if (this.props.inside) {
            return (
                ...
                maxZoom={this.props.maxZoom} mapName={mapName} bounds={bounds}
                unclustered_markers={unclustered_markers} legend_icon={legend_icon} renderMarkers={this.renderMarkers}
                back_button_icon={back_button_icon} setHovered={this.setHovered} />
            )
        } else {
            return (
