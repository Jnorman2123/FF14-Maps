  ...
  return (
    <div>
        {regionNames.map((regionName: string) => {
            ...
            return <Menu key={regionName} as="div" className="relative inline-block text-left">
                <div>
                ...
                >
                    <Menu.Items className="absolute right-0 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1
