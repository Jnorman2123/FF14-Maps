...
function RegionMapCont(props) {
    ...
    //     super(props);
    //     this.state = {
    //         la_noscea_zone_marker: ,
    //         the_black_shroud_zone_marker: ,
    //         thanalan_zone_marker: ,
    //         highlighted_markers: [],
    //         navigate: false,
    //         navigate_link: '',
    //     };
    ...
    let createZoneLegend = (quests, zone) => {
        ...
        let main_quest_icon = `./icons/quest_legend_icons/${
            props.setStartersLength(quests.main_starters, zone)}.png`;
        let class_quest_icon = `./icons/quest_legend_icons/${
            props.setStartersLength(quests.class_starters, zone)}.png`;
        let side_quest_icon = `./icons/quest_legend_icons/${
            props.setStartersLength(quests.side_starters, zone)}.png`;
        let hunting_quest_icon = `./icons/quest_legend_icons/${
            props.setStartersLength(quests.hunting_starters, zone)}.png`;
    ...
    let limsa_lominsa_upper_decks_icon = props.createIcon(`./highlighted_maps/LimsaLominsaUpperDecksHighlighted.jpg`, 
        [92.04, 141.96]);
    let limsa_lominsa_lower_decks_icon = props.createIcon(`./highlighted_maps/LimsaLominsaLowerDecksHighlighted.jpg`, 
        [138.06, 93.6]);
    let middle_la_noscea_icon = props.createIcon(`./highlighted_maps/MiddleLaNosceaHighlighted.jpg`, 
        [166.14, 193.44]);
    let lower_la_noscea_icon = props.createIcon(`./highlighted_maps/LowerLaNosceaHighlighted.jpg`, 
        [168.63, 243.32]);
    let eastern_la_noscea_icon = props.createIcon(`./highlighted_maps/EasternLaNosceaHighlighted.jpg`, 
        [227.075, 187.55]);
    let western_la_noscea_icon = props.createIcon(`./highlighted_maps/WesternLaNosceaHighlighted.jpg`, 
        [255.84, 210.6]);
    let upper_la_noscea_icon = props.createIcon(`./highlighted_maps/UpperLaNosceaHighlighted.jpg`, 
        [198.66, 93.17]);
    let outer_la_noscea_icon = props.createIcon(`./highlighted_maps/OuterLaNosceaHighlighted.jpg`, 
        [154.44, 137.28]);
    let old_gridania_icon = props.createIcon(`./highlighted_maps/OldGridaniaHighlighted.jpg`, 
        [134.16, 92.82]);
    let new_gridania_icon = props.createIcon(`./highlighted_maps/NewGridaniaHighlighted.jpg`, 
        [95.16, 69.42]);
    let east_shroud_icon = props.createIcon(`./highlighted_maps/EastShroudHighlighted.jpg`, 
        [217.62, 196.56]);
    let north_shroud_icon = props.createIcon(`./highlighted_maps/NorthShroudHighlighted.jpg`, 
        [177.06, 133.38]);
    let central_shroud_icon = props.createIcon(`./highlighted_maps/CentralShroudHighlighted.jpg`, 
        [199.68, 167.7]);
    let south_shroud_icon = props.createIcon(`./highlighted_maps/SouthShroudHighlighted.jpg`, 
        [201.24, 195.78]);
    let uldah_steps_of_nald_icon = props.createIcon(`./highlighted_maps/Ul'dah-StepsOfNaldHighlighted.jpg`, 
        [113.88, 91.26]);
    let uldah_steps_of_thal_icon = props.createIcon(`./highlighted_maps/Ul'dah-StepsOfThalHighlighted.jpg`, 
        [113.88, 86.58]);
    let hustings_strip_icon = props.createIcon(`./highlighted_maps/HustingsStripHighlighted.jpg`, 
        [118.56, 91.26]);
    let western_thanalan_icon = props.createIcon(`./highlighted_maps/WesternThanalanHighlighted.jpg`, 
        [204.82, 217.14]);
    let eastern_thanalan_icon = props.createIcon(`./highlighted_maps/EasternThanalanHighlighted.jpg`, 
        [212.16, 175.5]);
    let central_thanalan_icon = props.createIcon(`./highlighted_maps/CentralThanalanHighlighted.jpg`, 
        [164.3, 216.225]);
    let southern_thanalan_icon = props.createIcon(`./highlighted_maps/SouthernThanalanHighlighted.jpg`, 
        [219.325, 311.55]);
    let northern_thanalan_icon = props.createIcon(`./highlighted_maps/NorthernThanalanHighlighted.jpg`, 
        [127.1, 203.825]);
    ...
    let limsa_lominsa_upper_decks_legend_icons = createZoneLegend(props.quest_starters, 'Limsa Lominsa Upper Decks');
    let limsa_lominsa_lower_decks_legend_icons = createZoneLegend(props.quest_starters, 'Limsa Lominsa Lower Decks');
    let middle_la_noscea_legend_icons = createZoneLegend(props.quest_starters, 'Middle La Noscea');
    let lower_la_noscea_legend_icons = createZoneLegend(props.quest_starters, 'Lower La Noscea');
    let eastern_la_noscea_legend_icons = createZoneLegend(props.quest_starters, 'Eastern La Noscea');
    let western_la_noscea_legend_icons = createZoneLegend(props.quest_starters, 'Western La Noscea');
    let upper_la_noscea_legend_icons = createZoneLegend(props.quest_starters, 'Upper La Noscea');
    let outer_la_noscea_legend_icons = createZoneLegend(props.quest_starters, 'Outer La Noscea');
    let old_gridania_legend_icons = createZoneLegend(props.quest_starters, 'Old Gridania');
    let new_gridania_legend_icons = createZoneLegend(props.quest_starters, 'New Gridania');
    let east_shroud_legend_icons = createZoneLegend(props.quest_starters, 'East Shroud');
    let north_shroud_legend_icons = createZoneLegend(props.quest_starters, 'North Shroud');
    let central_shroud_legend_icons = createZoneLegend(props.quest_starters, 'Central Shroud');
    let south_shroud_legend_icons = createZoneLegend(props.quest_starters, 'South Shroud');
    let uldah_steps_of_nald_legend_icons = createZoneLegend(props.quest_starters, `Ul'dah - Steps of Nald`);
    let uldah_steps_of_thal_legend_icons = createZoneLegend(props.quest_starters, `Ul'dah - Steps of Thal`);
    let hustings_strip_legend_icons = createZoneLegend(props.quest_starters, 'Hustings Strip');
    let western_thanalan_legend_icons = createZoneLegend(props.quest_starters, 'Western Thanalan');
    let eastern_thanalan_legend_icons = createZoneLegend(props.quest_starters, 'Eastern Thanalan');
    let central_thanalan_legend_icons = createZoneLegend(props.quest_starters, 'Central Thanalan');
    let southern_thanalan_legend_icons = createZoneLegend(props.quest_starters, 'Southern Thanalan');
    let northern_thanalan_legend_icons = createZoneLegend(props.quest_starters, 'Northern Thanalan');
    ...
    return (
        <Container>
            <RegionMapComponent mapName={mapName} bounds={props.bounds} center={props.center} 
                ...
                highlighted_markers]} createHoverOverlay={createHoverOverlay} 
