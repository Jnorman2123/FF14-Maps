...
class WorldMapCont extends Component {
        ...
        this.state = {la_noscea_key_markers:
            {
                legend_icon: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/QuestTotalsBox.png`, 
                    ...
                    z_offset: this.props.leg_attrs.legend_z_offset},
                legend_arrow: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/QuestTotalsBoxPointerUp.png`, 
                    iconSize: [this.props.leg_attrs.vert_arrow_size]}), 
                    position: [this.props.world_map_attrs.la_noscea_legend_pos[0] + this.props.leg_attrs.vert_arrow_offset,
                    this.props.world_map_attrs.la_noscea_legend_pos[1]], z_offset: this.props.leg_attrs.arrow_z_offset},
                main_quest_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.la_noscea_legend_pos[0] + this.props.leg_attrs.top_num_offset,
                    this.props.world_map_attrs.la_noscea_legend_pos[1] + this.props.leg_attrs.left_num_offset], 
                    z_offset: this.props.leg_attrs.legend_num_z_offset},
                class_quest_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.la_noscea_legend_pos[0] + this.props.leg_attrs.bot_num_offset,
                    this.props.world_map_attrs.la_noscea_legend_pos[1] + this.props.leg_attrs.left_num_offset], 
                    z_offset: this.props.leg_attrs.legend_num_z_offset},
                side_quest_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.la_noscea_legend_pos[0] + this.props.leg_attrs.top_num_offset,
                    this.props.world_map_attrs.la_noscea_legend_pos[1] + this.props.leg_attrs.right_num_offset], 
                    z_offset: this.props.leg_attrs.legend_num_z_offset}, 
            ...
            {
                legend_icon: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/QuestTotalsBox.png`, 
                    iconSize: [this.props.leg_attrs.legend_size]}), position: [this.props.world_map_attrs.thanalan_legend_pos], 
                    z_offset: this.props.leg_attrs.legend_z_offset},
                legend_arrow: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/QuestTotalsBoxPointerLeft.png`, 
                    iconSize: [this.props.leg_attrs.hor_arrow_size]}), 
                    position: [this.props.world_map_attrs.thanalan_legend_pos[0] - this.props.leg_attrs.hor_arrow_offset,
                    this.props.world_map_attrs.thanalan_legend_pos[1]], z_offset: this.props.leg_attrs.arrow_z_offset},
                main_quest_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.thanalan_legend_pos[0] + this.props.leg_attrs.top_num_offset,
                    this.props.world_map_attrs.thanalan_legend_pos[1] + this.props.leg_attrs.left_num_offset], 
                    z_offset: this.props.leg_attrs.legend_num_z_offset},
                class_quest_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.thanalan_legend_pos[0] + this.props.leg_attrs.bot_num_offset,
                    this.props.world_map_attrs.thanalan_legend_pos[1] + this.props.leg_attrs.left_num_offset], 
                    z_offset: this.props.leg_attrs.legend_num_z_offset},
                side_quest_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.thanalan_legend_pos[0] + this.props.leg_attrs.top_num_offset,
                    this.props.world_map_attrs.thanalan_legend_pos[1] + this.props.leg_attrs.right_num_offset], 
                    z_offset: this.props.leg_attrs.legend_num_z_offset}, 
                hunting_log_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.thanalan_legend_pos[0] + this.props.leg_attrs.bot_num_offset,
            ...
            {
                legend_icon: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/QuestTotalsBox.png`, 
                    iconSize: [this.props.leg_attrs.legend_size]}), position: [this.props.world_map_attrs.the_black_shroud_legend_pos], 
                    z_offset: this.props.leg_attrs.legend_z_offset},
                legend_arrow: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/QuestTotalsBoxPointerLeft.png`, 
                    iconSize: [this.props.leg_attrs.hor_arrow_size]}), 
                    position: [this.props.world_map_attrs.the_black_shroud_legend_pos[0] - this.props.leg_attrs.hor_arrow_offset,
                    this.props.world_map_attrs.the_black_shroud_legend_pos[1]], z_offset: this.props.leg_attrs.arrow_z_offset},
                main_quest_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.the_black_shroud_legend_pos[0] + this.props.leg_attrs.top_num_offset,
                    this.props.world_map_attrs.the_black_shroud_legend_pos[1] + this.props.leg_attrs.left_num_offset], 
                    z_offset: this.props.leg_attrs.legend_num_z_offset},
                class_quest_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.the_black_shroud_legend_pos[0] + this.props.leg_attrs.bot_num_offset,
                    this.props.world_map_attrs.the_black_shroud_legend_pos[1] + this.props.leg_attrs.left_num_offset], 
                    z_offset: this.props.leg_attrs.legend_num_z_offset},
                side_quest_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.the_black_shroud_legend_pos[0] + this.props.leg_attrs.top_num_offset,
                    this.props.world_map_attrs.the_black_shroud_legend_pos[1] + this.props.leg_attrs.right_num_offset], 
                    z_offset: this.props.leg_attrs.legend_num_z_offset}, 
                hunting_log_number: {icon: new L.Icon({iconUrl: `./icons/quest_legend_icons/0.png`, 
                    iconSize: [this.props.leg_attrs.legend_num_size]}), 
                    position: [this.props.world_map_attrs.the_black_shroud_legend_pos[0] + this.props.leg_attrs.bot_num_offset,
    ...
    render () {
        ...
        let world_map_attrs = this.props.world_map_attrs;
